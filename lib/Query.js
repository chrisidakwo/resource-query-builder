...
var Query = /*#__PURE__*/function () {
  function Query() {
    ...
    this.base_url = (_options$base_url = options.base_url) !== null && _options$base_url !== void 0 ? _options$base_url : null;
  ...
  (0, _createClass2["default"])(Query, [{
    ...
    value: function get() {
      // generate the url
      var url = this.base_url ? this.base_url + this.parseQuery() : this.parseQuery();
    ...
    value: function where(key, value) {
      if (value == undefined) throw new Error('The where() function takes 2 arguments both of string values.');
      if (Array.isArray(value)) throw new Error('The second argument to the where() function must be a string. Use whereIn() if you need to pass in an array.');
